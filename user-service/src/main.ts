...
import { grpcUserClientOptions } from './generates/configGrpc/grpc-client.options';

async function bootstrap() {
  const app = await NestFactory.createMicroservice(AppModule, grpcUserClientOptions);
  // app.connectMicroservice(grpcUserClientOptions);
