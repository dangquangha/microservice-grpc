...
import { grpcPostClientOptions } from './generates/configGrpc/grpc-client.options';


async function bootstrap() {
  const app = await NestFactory.createMicroservice(AppModule, grpcPostClientOptions);
  // app.connectMicroservice(grpcPostClientOptions);
